...
public class SangueStatue : MonoBehaviour
{
    MouseFake mouse;
    GameObject june;
    ...
    private void Start()
    {
        tLight = GameObject.Find("SangueLight");
    ...
    public void TriggerDialogue()
    {
        ...
        twineTextPlayer.GetComponent<TwineTextPlayer>().Story = GetComponent<SangueDialogue>();
